...
import {Dimensions, StyleSheet, View, Text, Image, TouchableOpacity, Share} from "react-native";
...
const Page = () => {
    ...
    const listing = (ListingsData as IListing[]).find((item) => item.id === id);
        ...
        navigation.setOptions({
            ...
            headerRight: () => (
                <View style={styles.bar}>
                    <TouchableOpacity style={defaultStyles.roundButton} onPress={shareListing}>
